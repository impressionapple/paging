...
+ (instancetype)pageView
{
    ...
    NSBundle *lwqbundle = [NSBundle bundleForClass:[self class]];
    NSLog(@"%@",lwqbundle);
    return  [lwqbundle loadNibNamed:@"XMGPageView" owner:self options:nil].lastObject;
   
//    return [[lwqbundle loadNibNamed:NSStringFromClass(self) owner:nil options:nil] lastObject];
}
